...
coming from and why it is happening. **Find the bleeding
source**
...
**If its anterior** and a vessel can be seen, use a
...
**If its further back (mid septum)**, wrap surgicel
...
**If it's posterior: use a posterior pack**. Pumping
...
**If it's an HHT patient**. Surgiflo seems to work
...
**Operative Steps:** Place shoulder roll. mark out
...
off trachea w/ a peanut. Expose you window (2/3^rd^ tracheal
...
making two horizontal incisions over 2^nd^ and 3^rd^
...
- 
Orbital cellulitis is likely to have **chemosis**, pain
...
**When to drain a subperiosteal abscess?** If the
abscess volume is \<1250mm^3^ can avoid OR (measure abscess
...
**How to tell if there is a cavernous sinus
thrombosis**: get a MRI with contrast.
...
glottic/subglottic. Expiratory: trachea/bronchi. **Perform
fiberoptic exam and check airway**
...
Airway widely patent and mild edema, slow progression of
symptoms → observation on floor w/ O2 monitoring



- 

Airway patent but moderate edema (e.g. angioedema
patients) → observation in ICU



- 

Unable to entire airway → OR for awake fiberoptic
...
Unable to see any airway → OR for awake trach
